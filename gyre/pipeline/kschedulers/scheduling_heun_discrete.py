...
class HeunDiscreteScheduler(KSchedulerMixin, ConfigMixin):
    ...
    def step(
        ...
        if self.sigmas[index + 1] == 0:
            ...
            if noise_predictor:
                model_output_2 = noise_predictor(sample_2, self.timesteps[index + 1])
                pred_original_sample_2 = sample_2 - self.sigmas[index + 1] * model_output_2
            else:
                pred_original_sample_2 = sample_2 - self.sigmas[index + 1] * model_output

            derivative_2 = (sample_2 - pred_original_sample_2) / self.sigmas[index + 1]
